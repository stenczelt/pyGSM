...
class Molpro(Lot):
    ...
    def runall(self, geom, runtype=None):
        ...
        command = ['molpro']
        command.extend(args)
        output = subprocess.Popen(command, stdout=open('scratch/{}/gopro.out'.format(self.node_id), 'w'),
...
if __name__ == '__main__':
    ...
    molpro = Molpro.from_options(states=[(1, 0), (1, 1)], fnm=filepath, lot_inp_file='../../data/ethylene_molpro.com',
                                 coupling_states=(0, 1))
